...
function createData(deadline, task, taskOwner, department, state) {
  counter += 1;
  return { id: counter, deadline, task, taskOwner, department, state };
}
...
const rows = [
  ...
  { id: 'taskOwner', numeric: false, disablePadding: false, label: 'Task Owner' },
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell numeric>{n.task}</TableCell>
                      <TableCell numeric>{n.taskOwner}</TableCell>
                      <TableCell numeric>{n.department}</TableCell>
