...
class EmpTaskDetail extends React.Component {
  state = {
        ...
        <Dialog
          ...
          <DialogContent>
              ...
              <Grid item={ true } xs={12}>
                ...
                <a key= {file.id} href ={ 'http://dev.backend.team08.vse.handson.pro' + file.url} className="no-underline" target="_blank" rel="noopener noreferrer">
                <Chip
                  key= {file.id}
...
export default withStyles(styles)(EmpTaskDetail);
