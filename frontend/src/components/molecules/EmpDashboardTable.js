...
class EmpDashboardTable extends Component {
  ...
  render() {
    const { classes, tasks, filter, dateFilter, handleBadges, handleData } = this.props;
    ...
    return (
      <Paper className={classes.root}>
        <div className={classes.tableWrapper}>
          <Table className={classes.table} aria-labelledby="tableTitle" onChange={
            handleBadges(filteredByDateToday.length, filteredByDateWeek.length, filteredByDateMonth.length)}>
            <EnhancedTableHead
              order={order}
              orderBy={orderBy}
            ...
            <TableBody onChange={handleData(tasks)}>
...
const withStylesEmpDashboardTable  = withStyles(styles)(EmpDashboardTable);

const connectedEmpDashboardTable = connect(mapStateToProps,mapDispatchToProps)(withStylesEmpDashboardTable);
export {connectedEmpDashboardTable as EmpDashboardTable} ;
